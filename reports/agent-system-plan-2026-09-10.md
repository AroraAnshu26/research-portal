...
### 7.3 The knobs to turn before we build

These are the decisions I should not make for you, because they encode what you actually want rather than what is technically better.

**The funding floor.** Below what dollar amount does a round stop being worth a line? A 10 million dollar floor gives you roughly 20 to 40 items a week in your sectors; a 50 million floor gives you perhaps 8 to 15. The lower floor catches new entrants into the assurance seam earlier, which is directly thesis-relevant, at the cost of volume.

**Delivery time and channel.** The portal only, meaning you open it; or a file written to disk; or email. The portal is the least intrusive and the easiest to ignore.

**Whether Saturday and Sunday run.** Weekend policy shapes Monday: skipping the weekend makes Monday a three-day roll-up, which is usually better reading.

**One newsletter or five.** A single editor across all agents produces one page with ranking across axes, which is what the format above assumes. Per-agent newsletters give each axis its own voice and remove cross-axis ranking, at the cost of five things to read instead of one. My reading is that one page is right and that per-agent output should live in the portal as source records you can drill into, but you said you want a newsletter per agent, so this is the most important knob to settle before anything is built.

**Which domain the stock side starts with.** The candidates that fall directly out of your existing work are the robot policy layer, the datacenter and power buildout, and industrial certification and standards bodies as a business. The third is the least crowded and most directly load-bearing for your live thesis.

**The X account list.** This is unavoidably manual and it is the whole asset of agent F4. Roughly 150 accounts, and I can propose a first list of 60 to 80 from the names already in your research if you want to start from something rather than nothing.
