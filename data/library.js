...
,
{
  ...
  dek: "274 companies with at least one Stanford founder, built two ways: a systematic pass over all 3,014 companies in the YC directory from Winter 2022 on, reading 5,830 founder bios, plus a hand-verified layer carrying the money detail and the large non-YC names. Filter by how the founder was at Stanford, by named lab, by batch or by backer.",
  status: "live",
  date: "2026-09-14",
  owner: "anshu",
  open: "reports/stanford-students-building.html",
  openLabel: "Open dashboard",
  tags: ["274 companies", "252 from the YC census", "203 student-tie", "5,830 bios read", "18 entry points"],
  metrics: [
    { v: "28 → 274", l: "The correction. The first version of this board was built from press coverage and found 28; a systematic pass over the YC directory found 252, of which only 6 overlapped" },
    { v: "8.4%", l: "Stanford's share of the YC directory — 252 of 3,014 companies from W22 on have a founder whose own bio names Stanford. A base rate, not a shortlist" },
    { v: "203 of 274", l: "Carry a student-type tie: undergrad, master's, PhD, postdoc, MBA, researcher or left mid-degree. Master's and undergrad are the two largest determinable categories" },
    { v: "14 of 14", l: "Company-level precision on a hand-read random sample. Tie-kind precision is lower, which is why a large 'unspecified' bucket is reported rather than forced into a category" }
  ],
  body: [
    ["The correction, and why it happened", "This board first shipped on 2026-09-11 with 28 companies. Anshu pushed back on 2026-09-14 — \"thats way too little man there are so many more that have gotten into YC from stanford like enact, innate etc\" — and he was right. The 28 came from searching press coverage for Stanford student founders, which only surfaces large rounds, famous surnames and consumer products. Enact (S26, real-world RL environments for robotics, CTO out of Chelsea Finn's IRIS lab) and Innate (F24, personal AI robots, CEO a former Stanford HCI researcher) were both missing, and both are obvious the moment you read the directory instead of the news. An order-of-magnitude undercount is the expected output of that method, not bad luck. The lesson is general enough to keep: a census needs a denominator, and press coverage does not have one."],
  ...
  files: [
    { p: "reports/stanford-students-building.html", d: "Dashboard, 274 companies, four tabs, filter by tie / lab / batch / industry / layer" },
    ...
    { p: "tools/yc/build_students.py", d: "Merges the YC layer with the curated layer and renders the dashboard" },
